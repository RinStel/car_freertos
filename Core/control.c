...
void prvDebugTask(void *argument)
{
    ...
    TickType_t       xLastWakeTime;
    const TickType_t xFrequency = pdMS_TO_TICKS(1000 / DEBUG_TASK_FREQUENCY_HZ);
    ...
    for (;;)
    {
        ...
        printf("%ld, %ld\n", (long) xMotorEncoderData.left_speed,
               (long) xMotorEncoderData.right_speed);
